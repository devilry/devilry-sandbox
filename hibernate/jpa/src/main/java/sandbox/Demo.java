...
public class Demo {
	...
	public Demo(String persistenceUnit) {
	...
	public User add(String name) {
		...
		System.err.printf("** Added user ID: %d, NAME: %s%n", u.getId(), u
				.getName());
	...
	public User get(Long id) {
		...
		System.err.printf("** Got user ID: %d, NAME: %s%n", u.getId(), u
				.getName());
		return u;
	}
	...
	public User queryUser(String name) {
		...
		System.err.printf("** FOUND user ID: %d, NAME: %s%n", u.getId(), u
				.getName());
		return u;
	}
