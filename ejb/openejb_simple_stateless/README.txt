...
4) Run the client::
   ...
   ~# java -cp $OPENEJB_HOME/lib/openejb-client-3.0.jar:$OPENEJB_HOME/lib/javaee-5.0-1.jar:target/devilry-sandbox-openejb-simple-stateless-0.1.jar org.devilry.HelloClient
